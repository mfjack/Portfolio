   ...
   return (
      <div className="p-5">
         ...
         <p className="mt-10 text-sm">
            ...
            contribuir para a comunidade. Adoro colaborar em projetos que me permitem aplicar minha criatividade e habilidades técnicas para resolver problemas complexos. Além da minha vida
            profissional, valorizo muito meu tempo com minha família e amigos e aproveito as manhãs para surfar, uma atividade que me ajuda a começar o dia com energia e clareza mental.
         </p>
      </div>
   );
};
